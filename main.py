...
DESTINATION_CONTAINER_URI = os.getenv("DESTINATION_CONTAINER_URI")

NAME = "Simple batch transcription"
...
def transcribe():
    ...
    configuration.host = f"https://{SERVICE_REGION}.api.cognitive.microsoft.com/speechtotext/v3.2-preview.1"
